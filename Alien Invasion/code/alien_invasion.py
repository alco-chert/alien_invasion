...
class AlientInvasion:
    ...
    def __init__(self):
        ...
        # Создание экземпляра для хранения игровой статистики и панели резуьтаво.
    ...
    def _ship_hit(self):
        """Обрабатывает столкновление корабля с пришельцем."""
    ...
    def _update_bullets(self):
        ...
        # Удаление снарядов, вышедших за край экрага.
    ...
    def _update_aliens(self):
        """Обнавляет позиции всех пришельцеа во  флоте."""
    ...
    def _create_fleet(self):
        ...
        # Создание пришельца и вычесление кол во пришельцев в ряду.
    ...
    def _change_fleet_direction(self):
        """Опусткает весь флот и меняет направление флота."""
        for alien in self.aliens.sprites():
    ...
    def _update_screen(self):
            ...
            # Кнопка плей отображается в том случае, если игра неактивна.
